...
$(document.body).on('click','.sec', function(){
    var token =makeid(50);
    var id = $(".secVal").attr('id');
    $(this).attr("href","https://durak54.com.tr/tr/driver/accept?id="+id+"&token="+token);
    Cookies.set('quadros', token,{expires : 1})
});
...
function request_location()
{
    ...
    setTimeout(request_location, 2*1000);
...
function update_location(position)
{
    ...
    $.post("https://durak54.com.tr/tr/driver/index",
        {
            ...
            if (temp == 0){
                ...
                navigator.geolocation.getCurrentPosition(
                    (position) => {
                        ...
                        infoWindow.open(harita);

                        harita.setCenter(pos);
                    },
                    () => {
                        handleLocationError(true, infoWindow, harita.getCenter());
                    }
                );
...
$("#front_license").change(function(){ //dosya seçildiğinde
	
	var file_button = $(this); //butonu al
	var my_files = document.getElementById("front_license"); //file_upload id li elemanı al, file input
	//alert(my_files);
	if (my_files.files && my_files.files[0] && my_files.files[0].type.match('image.*')){ //dosya var ve resim türünde ise
		...
		reader.onload = function() { //veriyi yükle
			...
			$.post("https://durak54.com.tr/tr/driver/driver_license", {front:file_data}, function(result){
                     alert(result);       
                        });
		}
...
$("#back_license").change(function(){ //dosya seçildiğinde
	
	var file_button = $(this); //butonu al
	var my_files = document.getElementById("back_license"); //file_upload id li elemanı al, file input
	//alert(my_files);
	if (my_files.files && my_files.files[0] && my_files.files[0].type.match('image.*')){ //dosya var ve resim türünde ise
		var reader = new FileReader(); //FileReader class kur
		reader.onload = function() { //veriyi yükle
			...
			$.post("https://durak54.com.tr/tr/driver/driver_license", {back:file_data}, function(result){
                     alert(result);       
...
$("#front_personal").change(function(){ //dosya seçildiğinde
	
	var file_button = $(this); //butonu al
	var my_files = document.getElementById("front_personal"); //file_upload id li elemanı al, file input
	//alert(my_files);
	if (my_files.files && my_files.files[0] && my_files.files[0].type.match('image.*')){ //dosya var ve resim türünde ise
		var reader = new FileReader(); //FileReader class kur
		reader.onload = function() { //veriyi yükle
			...
			$.post("https://durak54.com.tr/tr/driver/personal_verification", {back:file_data}, function(result){
                     alert(result);       
...
$("#back_personal").change(function(){ //dosya seçildiğinde
	
	var file_button = $(this); //butonu al
	var my_files = document.getElementById("back_personal"); //file_upload id li elemanı al, file input
	//alert(my_files);
	if (my_files.files && my_files.files[0] && my_files.files[0].type.match('image.*')){ //dosya var ve resim türünde ise
		var reader = new FileReader(); //FileReader class kur
		reader.onload = function() { //veriyi yükle
...
$("#check_state").change(function(){
	$.post("https://durak54.com.tr/tr/driver/state", {check:1}, function(result){
                     alert(result);       
