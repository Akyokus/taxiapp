...
function getDistanceViaDistanceMatrix(points, unitType, callback) {
...
$("#file_upload").change(function(){ //dosya seçildiğinde
	...
	if (my_files.files && my_files.files[0] && my_files.files[0].type.match('image.*')){ //dosya var ve resim türünde ise
		...
		reader.onload = function() { //veriyi yükle
			...
			$.post("https://durak54.com.tr/tr/upload", {veri:file_data}, function(result){
                     alert(result);       
...
function myFunction(){
 var taxid = document.getElementById("basara").value;
		
	
	$.post("https://durak54.com.tr/tr/index", {driver_id:taxid}, function(result){
